...
class CameraClient internal constructor(builder: Builder) : IPreviewDataCallBack {
     ...
     */
    fun openCamera(cameraView: IAspectRatio? = null, isReboot: Boolean = false) {
    ...
    class Builder constructor() {
        ...
        fun setCameraStateCallback(back: ICameraStateCallBack?): Builder {
            this.cameraStateCallback = back
            return this
        }
